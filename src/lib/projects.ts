...
export const projects: Project[] = [
  {
    ...
    challenge: "Frame-by-frame age estimations fluctuated drastically, producing 'age jittering' that led to inconsistent safety enforcement across billions of videos. Ensuring temporal consistency was critical to fairness, compliance, and trust in large-scale moderation pipelines.",
    solution: "Introduced temporal embeddings into Vision Transformer architectures to reason across consecutive frames, trained on a 100K+ individual dataset expanding by 5K weekly. Deployed via RPC-based inference optimized with CUDA, TensorRT, and ONNX quantization to maintain p99 latency under 2 seconds at 11K QPS. This design balanced temporal accuracy with real-time responsiveness.",
    results: "Improved benchmark accuracy by +12%, stabilized predictions for over 1 billion daily videos, and reduced moderation inconsistency worldwide. The approach established a new internal standard for ethical, temporally consistent computer-vision safety models.",
    technicalHighlights: [
